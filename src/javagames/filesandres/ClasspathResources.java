...
public class ClasspathResources {
	...
	public void runTest() {
		...
		InputStream in = ClassLoader
				.getSystemResourceAsStream("javagame/filesandres/Test1.txt");
		printResource(in);
		/*
		...
		System.out.println();
		in = getClass().getResourceAsStream("/javagame/filesandres/Test2.txt");
		printResource(in);
		/*
		...
		System.out.println();
		in = getClass().getResourceAsStream("/javagame/filesandres/Test3.txt");
		printResource(in);
		/*
		...
		System.out.println("getClass() - Absolute path");
		System.out.println();
		in = ClasspathResources.class.getResourceAsStream("/javagame/filesandres/Test3.txt");
		printResource(in);
		/*
